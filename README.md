...
三个榜**分别**提交，每次只改一件事，不要把三榜分数平均来选「一个总模型」。P2 **停 TPS、停 `--use-flow`**。2026-09-05 验证榜分与当前最好文件见 [doc/t2_p2_val_2026-09-05.md](doc/t2_p2_val_2026-09-05.md)。

当前最好（与 `outputs/t2/submit/` 一致；旧预测在 `outputs/t2/archive/2026-09-06/`）：
